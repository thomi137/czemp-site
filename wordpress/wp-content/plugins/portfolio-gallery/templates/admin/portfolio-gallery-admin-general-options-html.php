						...
						<li id="portfolio-view-options-0">
							<div>   
								<h3><?php echo __( 'Element Styles', 'portfolio-gallery' );?></h3>
									...
									<label for="port_natural_size_toggle"><?php echo __( "Element's Image Behaviour", 'portfolio-gallery' );?></label>
									<select id="port_natural_size_contentpopup" name="params[port_natural_size_toggle]">
										<option <?php if($param_values['port_natural_size_toggle'] == 'resize'){ echo 'selected="selected"'; } ?> value="resize"><?php echo __( 'Resize', 'portfolio-gallery' );?></option>
										<option <?php if($param_values['port_natural_size_toggle'] == 'crop'){ echo 'selected="selected"'; } ?> value="crop"><?php echo __( 'Natural', 'portfolio-gallery' );?></option>
									</select>
								</div>
								<div>
							...
							<div style="margin-top:7px;">
								...
								<div class="has-background">
									...
									<input name="params[ht_view0_sorting_name_by_default]" type="text" id="ht_view0_sorting_name_by_default" value="<?php echo esc_attr($param_values['ht_view0_sorting_name_by_default']); ?>" size="10" class="text"/>
								</div>
								<div class="">
									<label for="ht_view0_sorting_name_by_id"><?php echo __( 'Sorting By Date Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view0_sorting_name_by_id]" type="text" id="ht_view0_sorting_name_by_id" value="<?php echo esc_attr($param_values['ht_view0_sorting_name_by_id']); ?>" size="10" />
								</div>
								<div class="has-background">
									<label for="ht_view0_sorting_name_by_name"><?php echo __( 'Sorting By Title Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view0_sorting_name_by_name]" type="text" id="ht_view0_sorting_name_by_name" value="<?php echo esc_attr($param_values['ht_view0_sorting_name_by_name']); ?>" size="10" />
								</div>
								<div class="">
									<label for="ht_view0_sorting_name_by_random"><?php echo __( 'Random Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view0_sorting_name_by_random]" type="text" id="ht_view0_sorting_name_by_random" value="<?php echo esc_attr($param_values['ht_view0_sorting_name_by_random']); ?>" size="10" />
								</div>
								<div class="has-background">
									<label for="ht_view0_sorting_name_by_asc"><?php echo __( 'Ascending Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view0_sorting_name_by_asc]" type="text" id="ht_view0_sorting_name_by_asc" value="<?php echo esc_attr($param_values['ht_view0_sorting_name_by_asc']); ?>" size="10" />
								</div>
								<div class="">
									<label for="ht_view0_sorting_name_by_desc"><?php echo __( 'Descending Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view0_sorting_name_by_desc]" type="text" id="ht_view0_sorting_name_by_desc" value="<?php echo esc_attr($param_values['ht_view0_sorting_name_by_desc']); ?>" size="10" />
								</div>
							</div>
							...
							<div style="margin-top: -198px;">
								...
								<div class="">
									...
									<input type="text" name="params[ht_view0_cat_all]" id="ht_view0_cat_all" value="<?php echo esc_attr($param_values['ht_view0_cat_all']); ?>" class="text" />
								</div>
								<div class="has-background">
								...
								<!--
                                                <div class="has-background">
                                                    <label for="ht_view0_filterbutton_width"><?php echo __( 'Filter Button Width', 'portfolio-gallery' );?></label>
                                                    <input type="text" name="params[ht_view0_filterbutton_width]" id="ht_view0_filterbutton_width" value="<?php echo $param_values['ht_view0_filterbutton_width']; ?>" class="text" />
                                                    <span>px</span>
                                                </div>
-->
							</div>
							...
							<div style="margin-top: 15px;">
								...
								<div>
									...
									<input type="text" name="params[ht_view0_linkbutton_text]" id="ht_view0_linkbutton_text" value="<?php echo esc_attr($param_values['ht_view0_linkbutton_text']); ?>" class="text" />
								</div>
								<div class="has-background">
						...
						<li id="portfolio-view-options-1">
							...
							<div style="margin-top:-80px;">
								...
								<div>
									...
									<input type="text" name="params[ht_view1_linkbutton_text]" id="ht_view1_linkbutton_text" value="<?php echo esc_attr($param_values['ht_view1_linkbutton_text']); ?>" class="text" />
								</div>
								<div class="has-background">
							...
							<div style="margin-top:14px;">
								...
								<div class="">
									...
									<input type="text" name="params[ht_view1_cat_all]" id="ht_view1_cat_all" value="<?php echo esc_attr($param_values['ht_view1_cat_all']); ?>" class="text" />
								</div>
								<div class="has-background">
							...
							<div style="margin-top: -404px;">
								...
								<div class="has-background">
									...
									<input name="params[ht_view1_sorting_name_by_default]" type="text" id="ht_view1_sorting_name_by_default" value="<?php echo esc_attr($param_values['ht_view1_sorting_name_by_default']); ?>" size="10" class="text"/>
								</div>
								<div class="">
									<label for="ht_view1_sorting_name_by_id"><?php echo __( 'Sorting By Date Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view1_sorting_name_by_id]" type="text" id="ht_view1_sorting_name_by_id" value="<?php echo esc_attr($param_values['ht_view1_sorting_name_by_id']); ?>" size="10" />
								</div>
								<div class="has-background">
									<label for="ht_view1_sorting_name_by_name"><?php echo __( 'Sorting By Title Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view1_sorting_name_by_name]" type="text" id="ht_view1_sorting_name_by_name" value="<?php echo esc_attr($param_values['ht_view1_sorting_name_by_name']); ?>" size="10" />
								</div>
								<div class="">
									<label for="ht_view1_sorting_name_by_random"><?php echo __( 'Random Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view1_sorting_name_by_random]" type="text" id="ht_view1_sorting_name_by_random" value="<?php echo esc_attr($param_values['ht_view1_sorting_name_by_random']); ?>" size="10" />
								</div>
								<div class="has-background">
									<label for="ht_view1_sorting_name_by_asc"><?php echo __( 'Ascending Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view1_sorting_name_by_asc]" type="text" id="ht_view1_sorting_name_by_asc" value="<?php echo esc_attr($param_values['ht_view1_sorting_name_by_asc']); ?>" size="10" />
								</div>
								<div class="">
									<label for="ht_view1_sorting_name_by_desc"><?php echo __( 'Descending Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view1_sorting_name_by_desc]" type="text" id="ht_view1_sorting_name_by_desc" value="<?php echo esc_attr($param_values['ht_view1_sorting_name_by_desc']); ?>" size="10" />
								</div>
								<div class="">
						...
						<li id="portfolio-view-options-2">
							<div>
								...
								<div>
									<label for="ht_view2_element_width"><?php echo __( "Element's Image Width", 'portfolio-gallery' );?></label>
								...
								<div class="has-background">
									<label for="ht_view2_element_height"><?php echo __( "Element's Image Height", 'portfolio-gallery' );?></label>
							...
							<div>
								...
								<div>
									...
									<input type="text" name="params[ht_view2_element_linkbutton_text]" id="ht_view2_element_linkbutton_text" value="<?php echo esc_attr($param_values['ht_view2_element_linkbutton_text']); ?>" class="text" />
								</div>
								<div class="has-background">
							...
							<div style="margin-top: -36px;">
								...
								<div class="has-background">
									...
									<input name="params[ht_view2_sorting_name_by_default]" type="text" id="ht_view2_sorting_name_by_default" value="<?php echo esc_attr($param_values['ht_view2_sorting_name_by_default']); ?>" size="10" class="text"/>
								</div>
								<div class="">
									<label for="ht_view2_sorting_name_by_id"><?php echo __( 'Sorting By Date Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view2_sorting_name_by_id]" type="text" id="ht_view2_sorting_name_by_id" value="<?php echo esc_attr($param_values['ht_view2_sorting_name_by_id']); ?>" size="10" />
								</div>
								<div class="has-background">
									<label for="ht_view2_sorting_name_by_name"><?php echo __( 'Sorting By Title Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view2_sorting_name_by_name]" type="text" id="ht_view2_sorting_name_by_name" value="<?php echo esc_attr($param_values['ht_view2_sorting_name_by_name']); ?>" size="10" />
								</div>
								<div class="">
									<label for="ht_view2_sorting_name_by_random"><?php echo __( 'Random Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view2_sorting_name_by_random]" type="text" id="ht_view2_sorting_name_by_random" value="<?php echo esc_attr($param_values['ht_view2_sorting_name_by_random']); ?>" size="10" />
								</div>
								<div class="has-background">
									<label for="ht_view2_sorting_name_by_asc"><?php echo __( 'Ascending Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view2_sorting_name_by_asc]" type="text" id="ht_view2_sorting_name_by_asc" value="<?php echo esc_attr($param_values['ht_view2_sorting_name_by_asc']); ?>" size="10" />
								</div>
								<div class="">
									<label for="ht_view2_sorting_name_by_desc"><?php echo __( 'Descending Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view2_sorting_name_by_desc]" type="text" id="ht_view2_sorting_name_by_desc" value="<?php echo esc_attr($param_values['ht_view2_sorting_name_by_desc']); ?>" size="10" />
								</div>
							</div>
							...
							<div style="margin-top: 14px;">
								...
								<div class="">
									...
									<input type="text" name="params[ht_view2_cat_all]" id="ht_view2_cat_all" value="<?php echo esc_attr($param_values['ht_view2_cat_all']); ?>" class="text" />
								</div>
								<div class="has-background">
							...
							<div style="margin-top: 14px;" >
								...
								<div>
									...
									<select id="ht_view2_thumbs_position" name="params[ht_view2_thumbs_position]">
										<option <?php if($param_values['ht_view2_thumbs_position'] == 'before'){ echo 'selected="selected"'; } ?> value="before"><?php echo __( 'Before Description', 'portfolio-gallery' );?></option>
										<option <?php if($param_values['ht_view2_thumbs_position'] == 'after'){ echo 'selected="selected"'; } ?> value="after"><?php echo __( 'After Description', 'portfolio-gallery' );?></option>
									</select>
								</div>
								<div class="has-background">
							...
							<div style="margin-top: 28px;">
								...
								<div>
									...
									<input type="text" name="params[ht_view2_popup_linkbutton_text]" id="ht_view2_popup_linkbutton_text" value="<?php echo esc_attr($param_values['ht_view2_popup_linkbutton_text']); ?>" class="text" />
								</div>
								<div class="has-background">
						...
						<li id="portfolio-view-options-3">
							...
							<div style="margin-top:-80px;">
								...
								<div class="has-background">
									...
									<input name="params[ht_view3_sorting_name_by_default]" type="text" id="ht_view3_sorting_name_by_default" value="<?php echo esc_attr($param_values['ht_view3_sorting_name_by_default']); ?>" size="10" class="text"/>
								</div>
								<div class="">
									<label for="ht_view3_sorting_name_by_id"><?php echo __( 'Sorting By Date Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view3_sorting_name_by_id]" type="text" id="ht_view3_sorting_name_by_id" value="<?php echo esc_attr($param_values['ht_view3_sorting_name_by_id']); ?>" size="10" />
								</div>
								<div class="has-background">
									<label for="ht_view3_sorting_name_by_name"><?php echo __( 'Sorting By Title Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view3_sorting_name_by_name]" type="text" id="ht_view3_sorting_name_by_name" value="<?php echo esc_attr($param_values['ht_view3_sorting_name_by_name']); ?>" size="10" />
								</div>
								<div class="">
									<label for="ht_view3_sorting_name_by_random"><?php echo __( 'Random Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view3_sorting_name_by_random]" type="text" id="ht_view3_sorting_name_by_random" value="<?php echo esc_attr($param_values['ht_view3_sorting_name_by_random']); ?>" size="10" />
								</div>
								<div class="has-background">
									<label for="ht_view3_sorting_name_by_asc"><?php echo __( 'Ascending Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view3_sorting_name_by_asc]" type="text" id="ht_view3_sorting_name_by_asc" value="<?php echo esc_attr($param_values['ht_view3_sorting_name_by_asc']); ?>" size="10" />
								</div>
								<div class="">
									<label for="ht_view3_sorting_name_by_desc"><?php echo __( 'Descending Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view3_sorting_name_by_desc]" type="text" id="ht_view3_sorting_name_by_desc" value="<?php echo esc_attr($param_values['ht_view3_sorting_name_by_desc']); ?>" size="10" />
								</div>
							</div>
							...
							<div style="margin-top: 14px;">
								...
								<div class="">
									...
									<input type="text" name="params[ht_view3_cat_all]" id="ht_view3_cat_all" value="<?php echo esc_attr($param_values['ht_view3_cat_all']); ?>" class="text" />
								</div>
								<div class="has-background">
							...
							<div style="margin-top: -50px;">
								...
								<div>
									...
									<input type="text" name="params[ht_view3_linkbutton_text]" id="ht_view3_linkbutton_text" value="<?php echo esc_attr($param_values['ht_view3_linkbutton_text']); ?>" class="text" />
								</div>
								<div class="has-background">
						...
						<li id="portfolio-view-options-4">
							...
							<div>
								...
								<div  class="has-background">
									...
									<select id="ht_view4_togglebutton_style" name="params[ht_view4_togglebutton_style]">
										<option <?php if($param_values['ht_view4_togglebutton_style'] == 'light'){ echo 'selected="selected"'; } ?> value="light"><?php echo __( 'Light', 'portfolio-gallery' );?></option>
										<option <?php if($param_values['ht_view4_togglebutton_style'] == 'dark'){ echo 'selected="selected"'; } ?> value="dark"><?php echo __( 'Dark', 'portfolio-gallery' );?></option>
									</select>
								</div>
							</div>
							...
							<div style="margin-top: 14px;">
								...
								<div class="has-background">
									...
									<input name="params[ht_view4_sorting_name_by_default]" type="text" id="ht_view4_sorting_name_by_default" value="<?php echo esc_attr($param_values['ht_view4_sorting_name_by_default']); ?>" size="10" class="text"/>
								</div>
								<div class="">
									<label for="ht_view4_sorting_name_by_id"><?php echo __( 'Sorting By Date Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view4_sorting_name_by_id]" type="text" id="ht_view4_sorting_name_by_id" value="<?php echo esc_attr($param_values['ht_view4_sorting_name_by_id']); ?>" size="10" />
								</div>
								<div class="has-background">
									<label for="ht_view4_sorting_name_by_name"><?php echo __( 'Sorting By Title Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view4_sorting_name_by_name]" type="text" id="ht_view4_sorting_name_by_name" value="<?php echo esc_attr($param_values['ht_view4_sorting_name_by_name']); ?>" size="10" />
								</div>
								<div class="">
									<label for="ht_view4_sorting_name_by_random"><?php echo __( 'Random Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view4_sorting_name_by_random]" type="text" id="ht_view4_sorting_name_by_random" value="<?php echo esc_attr($param_values['ht_view4_sorting_name_by_random']); ?>" size="10" />
								</div>
								<div class="has-background">
									<label for="ht_view4_sorting_name_by_asc"><?php echo __( 'Ascending Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view4_sorting_name_by_asc]" type="text" id="ht_view4_sorting_name_by_asc" value="<?php echo esc_attr($param_values['ht_view4_sorting_name_by_asc']); ?>" size="10" />
								</div>
								<div class="">
									<label for="ht_view4_sorting_name_by_desc"><?php echo __( 'Descending Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view4_sorting_name_by_desc]" type="text" id="ht_view4_sorting_name_by_desc" value="<?php echo esc_attr($param_values['ht_view4_sorting_name_by_desc']); ?>" size="10" />
								</div>
							</div>
							...
							<div style="margin-top: -600px;">
								...
								<div class="">
									...
									<input type="text" name="params[ht_view4_cat_all]" id="ht_view4_cat_all" value="<?php echo esc_attr($param_values['ht_view4_cat_all']); ?>" class="text" />
								</div>
								<div class="has-background">
								...
								<div class="">
									...
									<select id="ht_view4_filtering_float" name="params[ht_view4_filtering_float]">
										<option <?php if($param_values['ht_view4_filtering_float'] == 'left'){ echo 'selected="selected"'; } ?> value="left"><?php echo __( 'Left', 'portfolio-gallery' );?></option>
										<option <?php if($param_values['ht_view4_filtering_float'] == 'right'){ echo 'selected="selected"'; } ?> value="right"><?php echo __( 'Right', 'portfolio-gallery' );?></option>
										<option <?php if($param_values['ht_view4_filtering_float'] == 'top'){ echo 'selected="selected"'; } ?> value="top"><?php echo __( 'Top', 'portfolio-gallery' );?></option>
									</select>
								</div>
							...
							<div style="margin-top: -120px;">
								...
								<div>
									...
									<input type="text" name="params[ht_view4_linkbutton_text]" id="ht_view4_linkbutton_text" value="<?php echo esc_attr($param_values['ht_view4_linkbutton_text']); ?>" class="text" />
								</div>
								<div class="has-background">
						...
						<li id="portfolio-view-options-5">
							...
							<div style="margin-top:-65px;">
								...
								<div>
									...
									<input type="text" name="params[ht_view5_linkbutton_text]" id="ht_view5_linkbutton_text" value="<?php echo esc_attr($param_values['ht_view5_linkbutton_text']); ?>" class="text" />
								</div>
								<div class="has-background">
						...
						<li id="portfolio-view-options-6">
							...
							<div>
								...
								<div class="has-background">
									...
									<input name="params[ht_view6_sorting_name_by_default]" type="text" id="ht_view6_sorting_name_by_default" value="<?php echo esc_attr($param_values['ht_view6_sorting_name_by_default']); ?>" size="10" class="text"/>
								</div>
								<div class="">
									<label for="ht_view6_sorting_name_by_id"><?php echo __( 'Sorting By Date Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view6_sorting_name_by_id]" type="text" id="ht_view6_sorting_name_by_id" value="<?php echo esc_attr($param_values['ht_view6_sorting_name_by_id']); ?>" size="10" />
								</div>
								<div class="has-background">
									<label for="ht_view6_sorting_name_by_name"><?php echo __( 'Sorting By Title Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view6_sorting_name_by_name]" type="text" id="ht_view6_sorting_name_by_name" value="<?php echo esc_attr($param_values['ht_view6_sorting_name_by_name']); ?>" size="10" />
								</div>
								<div class="">
									<label for="ht_view6_sorting_name_by_random"><?php echo __( 'Random Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view6_sorting_name_by_random]" type="text" id="ht_view6_sorting_name_by_random" value="<?php echo esc_attr($param_values['ht_view6_sorting_name_by_random']); ?>" size="10" />
								</div>
								<div class="has-background">
									<label for="ht_view6_sorting_name_by_asc"><?php echo __( 'Ascending Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view6_sorting_name_by_asc]" type="text" id="ht_view6_sorting_name_by_asc" value="<?php echo esc_attr($param_values['ht_view6_sorting_name_by_asc']); ?>" size="10" />
								</div>
								<div class="">
									<label for="ht_view6_sorting_name_by_desc"><?php echo __( 'Descending Sorting Button Name', 'portfolio-gallery' );?></label>
									<input name="params[ht_view6_sorting_name_by_desc]" type="text" id="ht_view6_sorting_name_by_desc" value="<?php echo esc_attr($param_values['ht_view6_sorting_name_by_desc']); ?>" size="10" />
								</div>
							</div>
							...
							<div style="margin-top: -600px">
								...
								<div class="">
									...
									<input type="text" name="params[ht_view6_cat_all]" id="ht_view6_cat_all" value="<?php echo esc_attr($param_values['ht_view6_cat_all']); ?>" class="text" />
								</div>
								<div class="has-background">
