...
<?php } ?>
	<div id="huge_it_portfolio_container_<?php echo $portfolioID; ?>"
	     class="huge_it_portfolio_container super-list variable-sizes clearfix view-<?php echo $view_slug; ?>" <?php if ( $sortingFloatPopup == "top" && $filteringFloatPopup == "top" ) {
		...
		foreach ( $images as $key => $row ) {
			...
			?>
			<div id="huge_it_portfolio_pupup_element_<?php echo $row->id; ?>_child"
...
<ul id="huge_it_portfolio_popup_list_<?php echo $portfolioID; ?>" class="huge_it_portfolio_popup_list">
	<?php
	$changePopup = 1;
	foreach ( $images as $key => $row ) {
		...
		<li class="pupup-element <?php foreach ( $catForFilter as $catForFilterValue ) {
			echo str_replace( " ", "_", $catForFilterValue ) . " ";
		} ?>" id="huge_it_portfolio_pupup_element_<?php echo $row->id; ?>">
			<div class="heading-navigation heading-navigation_<?php echo $portfolioID; ?>">
